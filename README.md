...
## Author & License
**Author:** [Abbas El](https://github.com/AbbasEl11)  
**License:** [MIT](./LICENSE)

---

### Notes
- If audio does not play in the browser: start the game with a user interaction (click/keypress) first, as browsers often block autoplay.
